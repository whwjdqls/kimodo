#!/bin/bash
#SBATCH --job-name=mdm_hml3d_kimrep_nomask_fp32_1111111_100
#SBATCH --partition=a2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# --------- knobs ---------
RUN_NAME="mdm_hml3d_kimrep_nomask_fp32_1111111_100"
CONFIG="/home/jungbin_cho/kimodo_open/runs/mdm_hml3d_kimrep_nomask_fp32_1111111_100/config.yaml"
RESUME_FROM="/home/jungbin_cho/kimodo_open/runs/mdm_hml3d_kimrep_nomask_fp32_1111111_100/ckpt_step0040000.pt"   # set to "" to start fresh
# -------------------------
