#!/bin/bash
#SBATCH --job-name=mdm_hml3d_kimrep_fp32
#SBATCH --partition=a2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CONFIG="/home/jungbin_cho/kimodo_open/runs/mdm_hml3d_kimrep_fp32/config.yaml"
RESUME_FROM="/home/jungbin_cho/kimodo_open/runs/mdm_hml3d_kimrep_fp32/latest.pt"   # set to "" to start fresh
# -------------------------
