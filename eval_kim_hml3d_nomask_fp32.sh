#!/bin/bash
# Evaluate runs/kim_hml3d_nomask_fp32 with the MoMask/T2M evaluator.
#
# Kimodo TWO-stage on KIMODO 273-D representation, NO mask-concat input
# channel. Standard kimodo->humanml3d-263 conversion.
#
# Outputs:
#   runs/kim_hml3d_nomask_fp32/eval_<ckpt-stem>.json
#   runs/kim_hml3d_nomask_fp32/eval_<ckpt-stem>.log

set -uo pipefail

# --------- knobs (env overridable) ---------
RUN_NAME="kim_hml3d_nomask_fp32"
