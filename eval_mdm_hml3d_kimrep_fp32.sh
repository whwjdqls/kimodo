#!/bin/bash
# Evaluate runs/mdm_hml3d_kimrep_fp32 with the MoMask/T2M evaluator.
#
# MDM one-stage on KIMODO 273-D representation, mask=concat.
# Standard kimodo->humanml3d-263 conversion in evaluation/eval_hml3d.py.
#
# Outputs:
#   runs/mdm_hml3d_kimrep_fp32/eval_<ckpt-stem>.json
#   runs/mdm_hml3d_kimrep_fp32/eval_<ckpt-stem>.log

set -uo pipefail

# --------- knobs (env overridable) ---------
RUN_NAME="mdm_hml3d_kimrep_fp32"
